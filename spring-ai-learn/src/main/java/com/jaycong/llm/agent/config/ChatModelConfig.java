package com.jaycong.llm.agent.config;
...
//        String apiKey = getConfigValue(config, "spring.ai.openai.api-key");
        String apiKey = "sk-ws-H.EEYELEX.vh6R.MEQCIBd5JOBgoMgetuPaFikrAxBJfIQ-dutSSC35GWT837zPAiBJPaovXIuF8C5uTyqAMe07bF2nDlOnpYC6QNE0N4vFyw";
